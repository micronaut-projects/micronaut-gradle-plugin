...
micronaut {
    ...
    // In some circumstances, automatic dependencies – e.g. annotation processors listed above – can get in the way.
    // This should be rare but it is possible to suppress these, as follows:
