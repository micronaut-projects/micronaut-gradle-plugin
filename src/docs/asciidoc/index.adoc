...
tasks.named<MicronautDockerfile>("dockerfile") {
  baseImage.set("oracle/graalvm-ce:22.2.0-java11")
}
----
...
It is capable of generating a docker image containing a CRaC enabled JDK and a pre-warmed, checkpointed application via a new task `cracDockerBuild`.
