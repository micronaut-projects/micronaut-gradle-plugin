...
- by default, test resources support is wired into all Gradle `Test` tasks. Set the `testTasks` property to a non-empty list of task names, such as `integrationTest`, to restrict wiring to those specific `Test` tasks.
