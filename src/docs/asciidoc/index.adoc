...
For `lambda_provided`, the function plugins auto-apply the `application` plugin and keep the configured `application.mainClass` for runner JAR and native-image packaging.
