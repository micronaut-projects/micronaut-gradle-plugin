...
If you use the <<sec:micronaut-platform-catalog-plugin,Micronaut Platform Catalog plugin>>, then overriding versions of individual modules can easily be done by creating a `gradle/mn.versions.toml` file:
