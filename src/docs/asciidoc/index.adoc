...
# Setup explicitly that the Java version to use should be the one from the GRAALVM_HOME environment variable
...
There is currently no advantage in applying this plugin separately since it aims at configuring a Micronaut Application for GraalVM.
