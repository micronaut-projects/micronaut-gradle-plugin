...
public record AutomaticDependency(
    ...
    public Optional<Dependency> resolve(Project p) {
        ...
        if (versionProperty.isPresent()) {
            ...
            if (provider != null && provider.isPresent()) {
                return Optional.of(dependencyHandler.create(coordinates + ":" + provider.get()));
            }
        }
        ...
        if (versionCatalogs != null) {
            ...
            if (mn.isPresent()) {
                ...
                if (dependencyProvider.isPresent()) {
                    return Optional.of(dependencyProvider.get().get());
                }
            }
        }
        return Optional.of(dependencyHandler.create(coordinates));
    }
